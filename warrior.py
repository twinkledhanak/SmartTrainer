# this file consists of code only for downward facing dog
...
ptsg1 = deque(maxlen=args["buffer"]) # green : neck
ptsg2 = deque(maxlen=args["buffer"]) # blue : hip

gap = 9
etype, epair, emeasure = posture.getExerciseDetails("warrior")
